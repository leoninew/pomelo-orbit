...
func (s Server) createRoute(w http.ResponseWriter, r *http.Request) {
	...
	route := orbit.Route{Id: orbit.NewId(), ProjectId: &projectId, Name: req.Name, Domain: req.Domain, PathPrefix: req.PathPrefix, TargetURL: req.TargetURL, Enabled: req.Enabled, HTTPSEnabled: false, CertType: certTypeManual}
...
func routeResponse(route orbit.Route) routeResp {
...
func applyRouteUpdateReq(w http.ResponseWriter, route *orbit.Route, req routeUpdateReq) bool {
	if req.Name != nil {
...
func (s Server) loadRouteForCurrentUser(w http.ResponseWriter, r *http.Request) (orbit.Route, bool) {
	current, ok := s.currentUser(w, r)
	if !ok {
		return orbit.Route{}, false
	}
...
func (s Server) syncRouteFiles(w http.ResponseWriter, r *http.Request, route orbit.Route) bool {
...
func (s Server) deployRouteFile(w http.ResponseWriter, r *http.Request, route orbit.Route) bool {
...
func routeTraefikConfig(route orbit.Route) map[string]any {
