...
type pipelineSnapshotResp struct {
	...
	StagesSnapshot    []orbit.StageDefinition     `json:"stages_snapshot"`
...
func pipelineSnapshotResponse(w http.ResponseWriter, snapshot orbit.PipelineSnapshot) (pipelineSnapshotResp, bool) {
...
func pipelineSnapshotStages(w http.ResponseWriter, value string) ([]orbit.StageDefinition, bool) {
	if strings.TrimSpace(value) == "" {
		return []orbit.StageDefinition{}, true
	}
...
func pipelineSnapshotVariables(w http.ResponseWriter, value string) ([]orbit.VariableDeclaration, bool) {
	if strings.TrimSpace(value) == "" {
