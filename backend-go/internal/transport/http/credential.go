...
func (s Server) createCredentialRecord(w http.ResponseWriter, r *http.Request, projectId string, name string, credentialType string, data string) (repository.Credential, bool) {
...
func (s Server) loadCredentialForCurrentUser(w http.ResponseWriter, r *http.Request) (repository.Credential, bool) {
	current, ok := s.currentUser(w, r)
	if !ok {
		return repository.Credential{}, false
	}
