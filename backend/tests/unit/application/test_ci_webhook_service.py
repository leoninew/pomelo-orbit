...
class TestHandleGithubWebhook:
    ...
    def test_trigger_pipeline_success(self):
        project = Project.create(
            ...
            pipeline_snapshot_id="snapshot-1",
        )
        ...
        pipeline_service.create_run.return_value = (run, project, {})
        ...
        pipeline_service.create_run.assert_called_once()
