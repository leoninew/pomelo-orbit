...
- 2026-08-29：确认将 Traefik 全量同步从本 DNS-01 需求拆分为独立的轻量 SpecFlow 任务，见 [Route REST 快照防误删](../intent/20260819-route-rest-snapshot-safety.md)。本任务只保留 Gateway profile、DNS-01 和 Route capability 约束。
