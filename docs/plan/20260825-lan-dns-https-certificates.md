...
- 2026-08-29：确认将 Route 与 Traefik REST provider 的同步拆分为独立轻量 SpecFlow 任务；本计划不实现其 API、前端交互或验收，见 [Route REST 快照防误删](../intent/20260819-route-rest-snapshot-safety.md)。
