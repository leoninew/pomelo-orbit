export default {
	...
	route: {
		...
		validation: {
			nameInvalid: 'Must start with a lowercase letter and only contain lowercase letters, numbers, dots, underscores, and hyphens',
			domainRequired: 'Domain is required',
	...
	pipelineTemplate: {
		...
		repositoryMissingCredential: 'This project has no Git credential configured. Configure it in repository details before running.',
