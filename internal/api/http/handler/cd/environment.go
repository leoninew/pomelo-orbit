...
func (h Handler) ListEnvironments(c *gin.Context) {
	...
	transportresponse.ProtoJSON(c, http.StatusOK, &pomeloorbit.EnvironmentPaginatedResp{
...
func (h Handler) CreateEnvironment(c *gin.Context) {
	...
	var req pomeloorbit.EnvironmentCreateReq
...
func (h Handler) UpdateEnvironment(c *gin.Context) {
	...
	var req pomeloorbit.EnvironmentUpdateReq
	if err := binding.DecodeJSON(c, &req); err != nil {
		transportresponse.Error(c, http.StatusBadRequest, "Invalid JSON body")
		return
	}
