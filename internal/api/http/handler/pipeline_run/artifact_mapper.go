...
func artifactResponse(item model.Artifact) pipelinerunv1.ArtifactResp {
	return pipelinerunv1.ArtifactResp{
		...
		LocalImageSha256:      item.LocalImageSha256,
		SourceCommitSha:       item.SourceCommitSha,
		ApplicationId:         item.ApplicationId,
		ApplicationName:       item.ApplicationName,
		SourceVersionId:       item.SourceVersionId,
		SourceVersionLabel:    item.SourceVersionLabel,
		GeneratedVersionId:    item.GeneratedVersionId,
		GeneratedVersionLabel: item.GeneratedVersionLabel,
		VersionComponentId:    item.VersionComponentId,
		VersionComponentName:  item.VersionComponentName,
	}
}
