...
type ApplicationService interface {
	...
	UpdateVersion(context.Context, string, string, string, applicationdto.VersionUpdateInput) (applicationdto.VersionView, error)
	...
	UpdateVersionComponentMounts(context.Context, string, string, string, string, applicationdto.VersionComponentMountsUpdateInput) (model.VersionComponent, error)
	UpdateVersionComponentDependencies(context.Context, string, string, string, string, applicationdto.VersionComponentDependenciesUpdateInput) (model.VersionComponent, error)
	UpdateVersionComponentAdvanced(context.Context, string, string, string, string, applicationdto.VersionComponentAdvancedUpdateInput) (model.VersionComponent, error)
	UpdateVersionComponentDevices(context.Context, string, string, string, string, applicationdto.VersionComponentDevicesUpdateInput) (model.VersionComponent, error)
	PublishVersion(context.Context, string, string, string) (applicationdto.VersionView, error)
	DeleteVersion(context.Context, string, string, string) error
}

type ServiceService interface {
	ListServicesByApplication(context.Context, string, string, string) ([]model.Service, error)
	GetService(context.Context, string, string, string) (servicedto.ServiceView, error)
	CreateService(context.Context, string, string, servicedto.ServiceCreateInput) (servicedto.ServiceView, error)
	UpdateServiceComponentOverlay(context.Context, string, string, string, string, servicedto.ServiceComponentOverlayInput) (model.ServiceComponent, error)
	UpdateServiceEnv(context.Context, string, string, string, servicedto.ServiceEnvUpdateInput) (servicedto.ServiceView, error)
	UpdateServiceBasic(context.Context, string, string, string, servicedto.ServiceBasicUpdateInput) (servicedto.ServiceView, error)
}
...
type DeploymentService interface {
	...
	RestartApplication(context.Context, string, string, string, deploymentdto.ServiceTargetInput) (string, error)
	...
	VerifyDeployment(context.Context, string, string, string, string, deploymentdto.DeploymentVerificationInput) (deploymentdto.DeploymentVerificationResult, error)
}
...
type GatewayService interface {
	...
	GatewayForUser(context.Context, string, string, string) (gatewaydto.GatewayView, error)
	UpdateGateway(context.Context, string, string, string, gatewaydto.GatewayUpdateInput) (gatewaydto.GatewayView, error)
...
type RouteService interface {
	...
	RouteForUser(context.Context, string, string, string) (model.Route, error)
