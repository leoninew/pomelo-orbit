...
func New(store Store, tasks cdport.TaskService, cfg config.Config, logger *slog.Logger, logStore cdport.LogReader, routePublisher cdport.RouteConfigPublisher, certificateGenerator cdport.RouteCertificateGenerator, traefikRouterClient cdport.TraefikRouterClient) Service {
...
func NewWithRunner(store Store, tasks cdport.TaskService, cfg config.Config, logger *slog.Logger, runner cdport.CommandRunner, logStore cdport.LogReader, routePublisher cdport.RouteConfigPublisher, certificateGenerator cdport.RouteCertificateGenerator, traefikRouterClient cdport.TraefikRouterClient) Service {
...
func NewExecutionService(store DeploymentExecutionStore, cfg config.Config, logger *slog.Logger, runner cdport.CommandRunner, logStore cdport.LogReader) Service {
