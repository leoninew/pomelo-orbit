...
func (s Service) CreateCredential(ctx context.Context, userId string, input cidto.CredentialCreateInput) (model.Credential, error) {
...
func (s Service) ImportCredential(ctx context.Context, userId string, input cidto.CredentialCreateInput) (model.Credential, error) {
...
func (s Service) CredentialDetailForUser(ctx context.Context, userId string, credentialId string) (cidto.CredentialDetail, error) {
	credential, err := s.loadCredentialForUser(ctx, userId, credentialId)
	if err != nil {
		return cidto.CredentialDetail{}, err
	}
	decrypted, err := s.decryptCredentialData(credential.EncryptedData)
	if err != nil {
		return cidto.CredentialDetail{}, err
	}
	return cidto.CredentialDetail{Credential: credential, Data: decrypted}, nil
}

func (s Service) UpdateCredential(ctx context.Context, userId string, credentialId string, input cidto.CredentialUpdateInput) (model.Credential, error) {
	credential, err := s.loadCredentialForUser(ctx, userId, credentialId)
	if err != nil {
		return model.Credential{}, err
	}
...
func (s Service) ExportCredential(ctx context.Context, userId string, credentialId string) (cidto.CredentialExport, error) {
	credential, err := s.loadCredentialForUser(ctx, userId, credentialId)
	if err != nil {
		return cidto.CredentialExport{}, err
	}
	decrypted, err := s.decryptCredentialData(credential.EncryptedData)
	if err != nil {
		return cidto.CredentialExport{}, err
	}
	return cidto.CredentialExport{Version: cidto.CredentialExportVersion, Name: credential.Name, Type: credential.Type, Data: decrypted}, nil
}
...
func normalizeCredentialCreateInput(input cidto.CredentialCreateInput) (string, string, string, string, error) {
