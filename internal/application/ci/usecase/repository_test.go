...
func TestNormalizeRepositoryCreateInputCompatibility(t *testing.T) {
	...
	name, code, repositoryURL, defaultBranch, credentialId, err := normalizeRepositoryCreateInput(cidto.RepositoryCreateInput{
		Name:            " Repo One ",
		Code:            "repo-one",
	...
	_, _, _, _, _, err = normalizeRepositoryCreateInput(cidto.RepositoryCreateInput{Name: "Repo", Code: "Repo One", RepositoryURL: "https://example.test/repo.git"})
