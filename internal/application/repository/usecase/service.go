...
func (s stores) RepositoryHasBoundPipelines(ctx context.Context, projectId string, id string) (bool, error) {
	return s.repository.RepositoryHasBoundPipelines(ctx, projectId, id)
}
