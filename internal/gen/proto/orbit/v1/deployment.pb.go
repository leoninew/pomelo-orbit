...
func (x *DeploymentLogsResp) Reset() {
	*x = DeploymentLogsResp{}
	mi := &file_orbit_v1_deployment_proto_msgTypes[0]
...
func (*DeploymentLogsResp) Descriptor() ([]byte, []int) {
	return file_orbit_v1_deployment_proto_rawDescGZIP(), []int{0}
}
...
func (x *DeploymentContainerLogsResp) Reset() {
	*x = DeploymentContainerLogsResp{}
	mi := &file_orbit_v1_deployment_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*DeploymentContainerLogsResp) Descriptor() ([]byte, []int) {
	return file_orbit_v1_deployment_proto_rawDescGZIP(), []int{1}
}
...
func (x *DeploymentResp) Reset() {
	*x = DeploymentResp{}
	mi := &file_orbit_v1_deployment_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*DeploymentResp) Descriptor() ([]byte, []int) {
	return file_orbit_v1_deployment_proto_rawDescGZIP(), []int{2}
}
...
func (x *DeploymentCancelReq) Reset() {
	*x = DeploymentCancelReq{}
	mi := &file_orbit_v1_deployment_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*DeploymentCancelReq) Descriptor() ([]byte, []int) {
	return file_orbit_v1_deployment_proto_rawDescGZIP(), []int{3}
}
...
func (x *DeploymentPaginatedResp) Reset() {
	*x = DeploymentPaginatedResp{}
	mi := &file_orbit_v1_deployment_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*DeploymentPaginatedResp) Descriptor() ([]byte, []int) {
	return file_orbit_v1_deployment_proto_rawDescGZIP(), []int{4}
}
...
var File_orbit_v1_deployment_proto protoreflect.FileDescriptor

const file_orbit_v1_deployment_proto_rawDesc = "" +
	"\n" +
	"\x19orbit/v1/deployment.proto\x12\borbit.v1\"y\n" +
	...
	"\fcom.orbit.v1B\x0fDeploymentProtoP\x01ZEgitee.com/leoninew/PomeloOrbit-go/internal/gen/proto/orbit/v1;orbitv1\xa2\x02\x03OXX\xaa\x02\bOrbit.V1\xca\x02\bOrbit\\V1\xe2\x02\x14Orbit\\V1\\GPBMetadata\xea\x02\tOrbit::V1b\x06proto3"

var (
	file_orbit_v1_deployment_proto_rawDescOnce sync.Once
	file_orbit_v1_deployment_proto_rawDescData []byte
)

func file_orbit_v1_deployment_proto_rawDescGZIP() []byte {
	file_orbit_v1_deployment_proto_rawDescOnce.Do(func() {
		file_orbit_v1_deployment_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_orbit_v1_deployment_proto_rawDesc), len(file_orbit_v1_deployment_proto_rawDesc)))
	})
	return file_orbit_v1_deployment_proto_rawDescData
}

var file_orbit_v1_deployment_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_orbit_v1_deployment_proto_goTypes = []any{
	(*DeploymentLogsResp)(nil),          // 0: orbit.v1.DeploymentLogsResp
	(*DeploymentContainerLogsResp)(nil), // 1: orbit.v1.DeploymentContainerLogsResp
	(*DeploymentResp)(nil),              // 2: orbit.v1.DeploymentResp
	(*DeploymentCancelReq)(nil),         // 3: orbit.v1.DeploymentCancelReq
	(*DeploymentPaginatedResp)(nil),     // 4: orbit.v1.DeploymentPaginatedResp
}
var file_orbit_v1_deployment_proto_depIdxs = []int32{
	2, // 0: orbit.v1.DeploymentPaginatedResp.items:type_name -> orbit.v1.DeploymentResp
...
func init() { file_orbit_v1_deployment_proto_init() }
func file_orbit_v1_deployment_proto_init() {
	if File_orbit_v1_deployment_proto != nil {
		return
	}
	file_orbit_v1_deployment_proto_msgTypes[2].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_orbit_v1_deployment_proto_rawDesc), len(file_orbit_v1_deployment_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_orbit_v1_deployment_proto_goTypes,
		DependencyIndexes: file_orbit_v1_deployment_proto_depIdxs,
		MessageInfos:      file_orbit_v1_deployment_proto_msgTypes,
	}.Build()
	File_orbit_v1_deployment_proto = out.File
	file_orbit_v1_deployment_proto_goTypes = nil
	file_orbit_v1_deployment_proto_depIdxs = nil
}
