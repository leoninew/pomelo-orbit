"""Render and check generated artifacts for the integrated RAGFlow contract."""
...
RENDERER_PATH = "skills/deploy-ragflow-integrated-orbit/render_contract.py"
...
def parse_args() -> argparse.Namespace:
    ...
    action.add_argument("--write", action="store_true", help="write integrated generated artifacts")
    action.add_argument("--check", action="store_true", help="fail when an integrated generated artifact has drifted")
...
def main() -> int:
    ...
    try:
        ...
        print(f"integrated deployment contract error: {error}", file=sys.stderr)
        return 2
    ...
    if drifted:
        print("generated integrated RAGFlow artifacts have drifted:", file=sys.stderr)
        for path in drifted:
