"""Focused tests for the integrated RAGFlow deployment contract renderer."""
...
RENDERER_SPEC = importlib.util.spec_from_file_location(
    "ragflow_integrated_contract_renderer",
...
class RAGFlowIntegratedContractRendererTests(unittest.TestCase):
    def setUp(self) -> None:
    ...
    def test_contract_only_owns_integrated_topology(self) -> None:
        application_codes = {application["code"] for application in self.contract["applications"]}

        self.assertEqual(application_codes, {"ragflow-integrated"})
        self.assertEqual(
