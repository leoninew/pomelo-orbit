...
INSERT INTO version_component_endpoint_new (component_id, protocol, container_port, mode, bind_address, listen_port, entrypoint, path_prefix, position)
...
ALTER TABLE route ADD COLUMN endpoint_protocol TEXT;
ALTER TABLE route ADD COLUMN endpoint_container_port INTEGER CHECK (endpoint_container_port IS NULL OR endpoint_container_port BETWEEN 1 AND 65535);
