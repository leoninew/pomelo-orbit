...
CREATE TABLE IF NOT EXISTS gateway_config (
    ...
    acme_profile VARCHAR(16) NOT NULL DEFAULT '',
...
CREATE TABLE IF NOT EXISTS gateway_acme_profile_version (
    ...
    profile VARCHAR(16) NOT NULL CHECK (profile IN ('base', 'http', 'dns', 'http-dns')),
...
CREATE TABLE IF NOT EXISTS route (
    ...
    acme_challenge VARCHAR(16) NOT NULL DEFAULT 'http' CHECK (acme_challenge IN ('http', 'dns')),
    created_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    updated_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    project_id TEXT REFERENCES project(id)
);
