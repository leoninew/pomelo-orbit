export default {
  ...
  nav: {
    ...
    mcpAccessTokens: 'MCP Access Tokens',
    projects: 'Projects',
    users: 'Users',
    roles: 'Roles',
  ...
  project: {
    ...
    initialization: {
      ...
      description:
        'Configure a deployment target, pass the environment check, and create the Gateway.',
      steps: {
        environment: 'Select environment',
        environmentHint: 'Choose a target and enter connection details',
        environmentNote: 'Save the target configuration.',
        probe: 'Prepare environment',
        probeHint: 'Check Docker and Compose',
        probeNote: 'Run the environment check.',
        gateway: 'Prepare gateway',
        gatewayHint: 'Enter initial Gateway settings',
        gatewayNote: 'Create Gateway resources.',
      },
      ...
      creating: 'Creating',
      loadFailed: 'Failed to load initialization status',
      saveFailed: 'Failed to save the environment',
      probeFailed: 'Environment probe failed',
      probeChecking: 'Checking deployment target',
      probeCheckingDescription:
        'Connecting to the target and verifying Docker Compose prerequisites…',
      probePassed: 'Environment is ready',
      probePassedDescription: 'The selected target passed the Docker Compose readiness check.',
      probeFailedTitle: 'Environment check failed',
      probeFailedDescription:
        'Review the diagnostic details, adjust the target if needed, and retry.',
      probeNotRun: 'Ready to check environment',
      probeNotRunDescription:
        'Run the probe to verify this saved target before creating the Gateway.',
      probeDiagnostic: 'Diagnostic',
      probeLastRun: 'Last checked',
      editEnvironment: 'Edit environment',
      continueToGateway: 'Continue to gateway',
      bootstrapHint: 'Install the generated deployment key, then run the probe again.',
      createFailed: 'Failed to create the gateway',
      saved: 'Environment saved',
      probeSucceeded: 'Environment probe succeeded',
      created: 'Gateway created and ready to deploy',
    },
    environment: {
      title: 'Deployment Environment',
      editTitle: 'Edit Deployment Environment',
      state: 'State',
      targetType: 'Type',
      platform: 'Platform',
      host: 'Host',
      hostPlaceholder: 'e.g. 192.168.1.10 or hostname',
      port: 'Port',
      sshTarget: 'SSH Target',
      username: 'SSH User',
      usernamePlaceholder: 'e.g. deploy or Administrator',
      workspaceRoot: 'Workspace Root',
      hostKeyFingerprint: 'Host Key Fingerprint',
      initialize: 'Initialize Deployment Host',
      windowsCommand: 'Windows setup command',
      initializeTitle: 'Initialize Deployment Host',
      initialized: 'Deployment host initialized',
      initializeFailed: 'Failed to initialize deployment host',
      bootstrapUsername: 'Bootstrap SSH User',
      authentication: 'Authentication',
      authenticationModes: {
        password: 'Password',
        privateKey: 'Private Key',
      },
      bootstrapPassword: 'SSH Password',
      bootstrapPrivateKey: 'SSH Private Key',
      bootstrapPrivateKeyPassphrase: 'Private Key Passphrase',
      sections: {
      ...
      lastProbeDiagnostic: 'Probe Diagnostic',
      probe: 'Probe',
      probing: 'Probing',
      probeSucceeded: 'Deployment environment probe succeeded',
      probeFailed: 'Deployment environment probe failed',
      probeStates: {
        succeeded: 'Passed',
        failed: 'Failed',
      },
      linuxWorkspacePlaceholder: '~/.pomelo-orbit',
      windowsWorkspacePlaceholder: 'e.g. C:\\Users\\<user>\\.pomelo-orbit',
      states: {
        active: 'Active',
        disabled: 'Disabled',
      },
      ...
      validation: {
        ...
        username: 'Enter a valid SSH user',
        workspaceRoot: 'Workspace root does not match the selected platform',
        bootstrapUsername: 'Enter a valid bootstrap SSH user',
        bootstrapPassword: 'Enter an SSH password',
        bootstrapPrivateKey: 'Enter an SSH private key',
      },
      loadFailed: 'Failed to load deployment environment',
      saveFailed: 'Failed to save deployment environment',
      updated: 'Deployment environment updated',
    },
  },
  application: {
  ...
  mcpAccessTokens: {
    create: 'Create token',
    name: 'Name',
    namePlaceholder: 'For example: Local Codex',
    expiresAt: 'Expires',
    createdAt: 'Created',
    ...
    createDialogTitle: 'Create MCP access token',
    createdDialogTitle: 'Copy access token',
    shownOnce: 'This token is shown once. It cannot be viewed again after closing this dialog.',
    copy: 'Copy',
    copyEnvironment: 'Copy environment variable',
    copied: 'Copied to clipboard',
    copyFailed: 'Failed to copy',
    revoke: 'Revoke token',
    revokeDialogTitle: 'Revoke MCP access token',
    revokeConfirm: 'This token will stop working for MCP sessions on their next tool call.',
    loadFailed: 'Failed to load MCP access tokens',
    createFailed: 'Failed to create MCP access token',
    revokeFailed: 'Failed to revoke MCP access token',
    revokeSuccess: 'MCP access token revoked',
