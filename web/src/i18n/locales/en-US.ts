export default {
  ...
  project: {
    ...
    exportHandover: 'Export handover package',
    handoverExported: 'Handover package exported',
    handoverExportFailed: 'Failed to export handover package',
    importHandover: 'Import handover package',
    ...
    initialization: {
      ...
      next: 'Next',
      testSSH: 'Check connection',
      testingSSH: 'Checking',
      testSSHPassed: 'SSH connection available',
      testSSHFailed: 'SSH connection is unavailable',
      saveRequiresSSHTest: 'Check the connection first; continue after it succeeds',
      windowsTargetCommandLabel: 'PowerShell command',
      windowsTargetCommand: 'Generate setup command',
      ...
      probeChecks: {
        target: 'Target connection and authentication',
        workspace: 'Workspace',
        wsl: 'WSL2 and Docker Desktop',
