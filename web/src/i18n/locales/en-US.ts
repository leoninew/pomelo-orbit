export default {
  ...
  project: {
    ...
    initialization: {
      ...
      next: 'Next',
      sshCommand: 'Generate initialization command',
      sshCommandTitle: 'SSH initialization command',
      sshCommandLoading: 'Generating command...',
      sshCommandCopy: 'Copy command',
      sshCommandCopied: 'Command copied',
      sshCommandCopyFailed: 'Could not copy the command; select it manually',
      sshCommandFailed:
    ...
    environment: {
      ...
      editTitle: 'Edit Project Environment',
      targetType: 'Type',
      platform: 'Platform',
      host: 'Host',
      ...
      loadFailed: 'Failed to load project environment',
      saveFailed: 'Failed to save project environment',
