export default {
  ...
  project: {
    ...
    environment: {
      ...
      createTitle: 'Deployment Environment',
      ...
      gatewayApplication: 'Gateway Application',
      ...
      deploymentSSHKeyName: 'Deployment SSH Key Name',
      deploymentSSHPrivateKey: 'Deployment SSH Private Key',
      deploymentSSHPrivateKeyHint: 'Leave empty to keep the current private key.',
      deploymentSSHKeyPassphrase: 'Private Key Passphrase',
      deploymentSSHKeyPassphraseHint: 'Provide only when replacing the private key.',
      linuxWorkspacePlaceholder: '/srv/pomelo-orbit',
      windowsWorkspacePlaceholder: 'C:\\pomelo-orbit',
      states: {
        active: 'Active',
        disabled: 'Disabled',
      },
      ...
      validation: {
        ...
        deploymentSSHKeyName: 'Enter a deployment SSH key name',
        deploymentSSHPrivateKey: 'Enter a deployment SSH private key',
        hostKeyFingerprint: 'Host key fingerprint must use SHA256 format',
      },
