export default {
  ...
  project: {
    ...
    exportHandover: '导出接管包',
    handoverExported: '接管包已导出',
    handoverExportFailed: '导出接管包失败',
    importHandover: '导入接管包',
    ...
    initialization: {
      ...
      testSSH: '检查连接',
      testingSSH: '检查中',
      testSSHPassed: 'SSH 连接可用',
      testSSHFailed: 'SSH 连接不可用',
      saveRequiresSSHTest: '请先检查连接；连接可用后才能进入下一步',
      windowsTargetCommandLabel: 'PowerShell 命令',
      windowsTargetCommand: '生成初始化命令',
  ...
  application: {
    ...
    detail: {
      ...
      empty: {
        ...
        services: '暂无服务，创建后会出现在此列表',
      },
      drawer: {
        composePreview: 'docker-compose 预览',
        composePreviewDescription:
          '由选定 Version 和服务渲染生成，与部署时写入的 docker-compose.yml 一致（含 Traefik labels）。',
      },
      dialog: {
      ...
      hints: {
        selectServiceTarget: '存在多个服务时，请选择要操作的目标。',
      },
      placeholders: {
        versionLabel: '例如: v1',
        note: '备注',
    ...
    toast: {
      ...
      serviceTargetRequired: '请选择要操作的服务',
  ...
  gateway: {
    ...
    toast: {
      ...
      versionRequired: '请选择版本',
      deployServiceRequired: '网关服务不可用',
      serviceRequired: '网关服务不可用',
      deployQueued: '部署已提交',
      deployFailed: '部署失败',
      stopQueued: '停止已提交',
      stopFailed: '停止失败',
