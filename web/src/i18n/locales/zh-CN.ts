export default {
  ...
  project: {
    ...
    initialization: {
      ...
      next: '下一步',
      sshCommand: '生成初始化命令',
      sshCommandTitle: 'SSH 初始化命令',
      sshCommandLoading: '正在生成命令...',
      sshCommandCopy: '复制命令',
      sshCommandCopied: '命令已复制',
      sshCommandCopyFailed: '复制命令失败，请手动选择复制',
      sshCommandFailed: '无法生成初始化命令，请检查当前环境配置后重试',
      probe: '检查就绪',
      probing: '检查中',
    ...
    environment: {
      ...
      probe: '探测',
      probing: '探测中',
      probeSucceeded: '项目环境探测成功',
      probeFailed: '项目环境探测失败',
      probeStates: {
        succeeded: '通过',
        failed: '失败',
      },
  ...
  gateway: {
    ...
    fields: {
      name: '名称',
      code: '编码',
      restApiUrl: '容器 REST API URL',
      restApiHostUrl: '宿主机 REST API URL',
      baseDomain: '基础域名',
    ...
    validation: {
      ...
      restApiHostUrlInvalid: '请输入有效的 HTTP 或 HTTPS URL',
