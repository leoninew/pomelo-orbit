export default {
  ...
  project: {
    ...
    environment: {
      ...
      deploymentSSHKeyName: '部署 SSH 密钥名称',
      deploymentSSHPrivateKey: '部署 SSH 私钥',
      deploymentSSHPrivateKeyHint: '留空表示保留当前私钥。',
      deploymentSSHKeyPassphrase: '私钥口令',
      deploymentSSHKeyPassphraseHint: '仅在替换私钥时填写。',
      ...
      validation: {
        ...
        deploymentSSHKeyName: '请输入部署 SSH 密钥名称',
        deploymentSSHPrivateKey: '请输入部署 SSH 私钥',
        hostKeyFingerprint: '主机密钥指纹必须为 SHA256 格式',
      },
      loadFailed: '加载部署环境失败',
      saveFailed: '保存部署环境失败',
      updated: '部署环境已更新',
