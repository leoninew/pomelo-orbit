        ...
        <table class="app-table-list min-w-[1080px]">
          ...
          <tbody>
            <tr v-for="svc in services" :key="svc.id">
                ...
                <div class="flex flex-col gap-0.5">
                  <div class="flex items-center gap-2">
                    <button
                      ...
                      @click="router.push(`/cd/application/${svc.application_id}`)"
                    >
              ...
              <td>
                <button class="app-link" @click="router.push(`/cd/version/${svc.version_id}`)">
              ...
              <td>
                <div class="flex items-center gap-3">
                  <button class="app-link" @click="router.push(`/cd/service/${svc.id}`)">
...
<script setup lang="ts">
  ...
  import type { ServiceResp } from '@/gen/proto/orbit/v1/version';
